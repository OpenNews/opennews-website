...
<img src="/media/img/blog/mpls_groupshot.jpg" style="width: 100%;" alt="McNamara Alumni Center aka Nerd Church" />
...
We'll have a lot more details to share about SRCCON soon. During [NICAR](https://www.ire.org/2017/06/21/welcome-to-the-2017-ire-conference//) at the beginning of March, we'll share the dates that tickets will go on sale and for the call for session proposals. If you're already eager to get connected, be sure to sign up for our email list and the [@SRCCON Twitter](https://www.twitter.com/srccon) for updates. And of your employer might be in a position to help make SRCCON happen, we are [looking for sponsors](https://www.srccon.org/sponsors).
