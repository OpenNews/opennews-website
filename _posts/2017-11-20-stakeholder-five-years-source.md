...
[Rachel Schallom](https://www.rachelschallom.com/) is a newsroom project manager at the Wall Street Journal who has written for Source about aspects of hiring as this field grows. Rachel tells of her experience joining the news nerd community:
...
- SRCCON:WORK is coming up December 7-8. You can [head over to Source for a series of Q&As](https://source.opennews.org/articles/tags/srcconwork-q-a_1/), which start today and will help introduce the people and the themes we'll be tackling at SRCCON:WORK. We're busy organizing all the final details, and if you'd like to join us, we're [still looking for sponsors](https://work.srccon.org/sponsors/details/) to help make this event accessible. (Thanks so much to [the sponsors](https://work.srccon.org/sponsors/) that have already joined us!)
