...
- We'll be continuing a number of our most successful programs, and beginning to build out new offerings as well. There is a ton we're working on, so hold on to your butts:
  ...
  - The community survey we took in 2016 that looked into the size and health of the journalism-code community will become a yearly census, the first results of which will be released at the [NICAR conference](https://ire.org/conferences/nicar2017/).
