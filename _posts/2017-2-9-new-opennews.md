...
Today is a big day for OpenNews. After six years with Mozilla, we're striking out on our own thanks to a new grant from the Knight Foundation. There are [press releases](http://kng.ht/2ls1EdB) and blog posts and this really is a big deal, but before we get to what's new I want to talk about our community.
...
* First and foremost, we are striking out on our own: as of today OpenNews is independent, working as a project of [Community Partners](http://www.communitypartners.org), a nonprofit fiscal sponsor. Our six years with [Mozilla](https://www.mozilla.org/en-US/foundation/) have been amazing and we've learned much of what we know about community from them. We've reached a point where we're mature enough as a program to head off on our own and we're excited to do so.
