...
Through these sessions, we see how much this community supports one another and pushes each other to implement more inclusive policies, and do more sustainable and interesting work. We can't wait to see what you want to dig into at this year's SRCCON, which brings us to some updates in the process.
