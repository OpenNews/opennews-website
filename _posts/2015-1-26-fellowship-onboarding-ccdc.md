...
We also prepared advance instructions for setting up a development environment so no one had to spend in-person group time just getting set up. We spent Wednesday and Thursday of the onboarding week working from a [beautiful new journalism building at USC](https://annenberg.usc.edu/about/facilities), beginning the first morning with some goal-setting and then breaking into front-end and back-end groups. All seven fellows came in with development and design experience, but this particular project still chalked up a lot of firsts: For some, it was their first time working in a collaborative environment, `git push`-ing into someone else's open-source project. For others, it was a chance to try out new software or visualization frameworks. For all of them, of course, it was their first time working with one another.
