...
In two short days, we'll close the session-proposal window for [SRCCON, our annual conference for newsroom developers, designers, and data analysts](https://srccon.org/). Every year, the deadline comes up faster than seems possible, but it's not yet too late—in fact, this is the _perfect_ time to [submit your pitch](https://srccon.org/sessions/pitch/).
...
- **[Send in the pitch!](https://srccon.org/sessions/pitch/)** This part is super-easy, but don't forget to do it **before midnight Pacific Time on April 20**. If you'd like to co-lead your session, you can tell us on your proposal and either give us your co-leader's name or ask us for help finding the right person.

Want more information or help figuring out your idea and approach? We've got you covered:

- [About SRCCON Sessions](https://srccon.org/sessions/)
- [How To Plan A Great SRCCON Session](https://opennews.org/blog/srccon-session-planning/)
- [How to Pitch (and Run) a Great SRCCON Session](https://srccon.org/sessions/great_session/)
- [How to Run a Great Unconference Session](https://scottberkun.com/2006/how-to-run-a-great-unconference-session/) (we didn't write this one, but it's great)
