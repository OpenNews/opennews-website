...
There's a lot of exciting experimentation happening with remote events right now, from Heather Bryant's [remote unconference](https://web.archive.org/web/20191115072251/http://www.unconference.community//) during NICAR this year to conferences like the [Collaborative Journalism Summit](https://collaborativejournalism.org/cjs2020/), [Change @ Work](https://web.archive.org/web/20240808045414/https://nobl.io/changemaker/change-at-work-round-up/), [Allied Media Conference](https://amc.alliedmedia.org/), and [csv,conf](https://csvconf.com/). We're looking forward to exploring how an interactive, collaborative conference like SRCCON might translate into virtual spaces.
