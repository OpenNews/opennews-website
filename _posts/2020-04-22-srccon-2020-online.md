...
There's a lot of exciting experimentation happening with remote events right now, from Heather Bryant's [remote unconference](https://www.unconference.community/) during NICAR this year to conferences like the [Collaborative Journalism Summit](https://collaborativejournalism.org/cjs2020/), [Change @ Work](https://changeatwork.nobl.io/), [Allied Media Conference](https://amc.alliedmedia.org/), and [csv,conf](https://csvconf.com/). We're looking forward to exploring how an interactive, collaborative conference like SRCCON might translate into virtual spaces.
