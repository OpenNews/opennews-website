      ...
      var f = {
        ...
        d = {
          ...
          transitionCallback: function () {
            return e.vendor === "Moz" || e.vendor === "ms"
              ? "transitionend"
              : e.vendor + "TransitionEnd";
          },
          canTransform: function () {
            return (
              typeof f.element.style[e.vendor + "Transform"] !== "undefined"
            );
          },
              ...
              if (e.isDragging && f.touchToDrag) {
                ...
                if (e.hasIntent === false || e.hasIntent === null) {
                  var m = d.angleOfDrag(v, u),
                    l =
                      (m >= 0 && m <= f.slideIntent) ||
                      (m <= 360 && m > 360 - f.slideIntent),
                    r =
                      (m >= 180 && m <= 180 + f.slideIntent) ||
                      (m <= 180 && m >= 180 - f.slideIntent);
                  if (!r && !l) {
                    e.hasIntent = false;
                  } else {
                ...
                if (p) {
                  ...
                  e.simpleStates = {
                    ...
                    flick:
                      Math.abs(e.dragWatchers.current - e.dragWatchers.hold) >
                      f.flickThreshold,
                    translation: {
                      absolute: o,
                      relative: n,
