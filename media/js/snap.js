      ...
      var settings = {
        ...
        utils = {
          ...
          vendor: function () {
            ...
            for (i in prefixes) {
              if (
                typeof tmp.style[prefixes[i] + "Transition"] !== "undefined"
              ) {
                return prefixes[i];
              }
            }
          ...
          canTransform: function () {
            return (
              typeof settings.element.style[cache.vendor + "Transform"] !==
              "undefined"
            );
          },
          ...
          drag: {
            ...
            dragging: function (e) {
              if (cache.isDragging && settings.touchToDrag) {
                ...
                if (
                  settings.minDragDistance >=
                    Math.abs(thePageX - cache.startDragX) || // Has user met minimum drag distance?
                  cache.hasIntent === false
                ) {
                  return;
                }
                ...
                if (openingLeft) {
                  ...
                  if (settings.maxPosition < absoluteTranslation) {
                    diff =
                      (absoluteTranslation - settings.maxPosition) *
                      settings.resistance;
                  ...
                  cache.simpleStates = {
                    ...
                    flick:
                      Math.abs(
                        cache.dragWatchers.current - cache.dragWatchers.hold
                    ...
                    translation: {
                      ...
                      sinceDirectionChange:
                        cache.dragWatchers.current - cache.dragWatchers.hold,
                      percentage:
                        (absoluteTranslation / settings.maxPosition) * 100,
                    },
                  };
                } else {
                  ...
                  if (settings.minPosition > absoluteTranslation) {
                    diff =
                      (absoluteTranslation - settings.minPosition) *
                      settings.resistance;
                    translateTo = whileDragX - diff;
                  }
                  cache.simpleStates = {
                    ...
                    translation: {
                      ...
                      sinceDirectionChange:
                        cache.dragWatchers.current - cache.dragWatchers.hold,
                      percentage:
                        (absoluteTranslation / settings.minPosition) * 100,
                    },
                  };
                }
                ...
                if (cache.simpleStates.opening === "left") {
                  ...
                  if (
                    ...
                    if (
                      ...
                      (cache.simpleStates.flick &&
                        cache.simpleStates.towards === "right") || // Flicking Open OR
                      cache.simpleStates.halfway ||
                  ...
                  if (
                    ...
                    if (
                      ...
                      (cache.simpleStates.flick &&
                        cache.simpleStates.towards === "left") || // Flicking Open OR
                      cache.simpleStates.halfway ||
                      cache.simpleStates.hyperExtending // At least halfway open OR hyperextending
                    ) {
