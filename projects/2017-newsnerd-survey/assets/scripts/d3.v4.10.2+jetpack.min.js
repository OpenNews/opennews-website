(function (global, factory) {
  ...
  var histogram = function () {
    ...
    function histogram(data) {
      ...
      if (!Array.isArray(tz)) {
        ...
        tz = range(Math.ceil(x0 / tz) * tz, Math.floor(x1 / tz) * tz, tz);
      }
      var m = tz.length;
  ...
  function tickIncrement$1(start, stop, count) {
    var step = (stop - start) / Math.max(0, count),
      ...
      error = step / Math.pow(10, power);
    return power >= 0
      ? (error >= e10$1 ? 10 : error >= e5$1 ? 5 : error >= e2$1 ? 2 : 1) *
          Math.pow(10, power)
      : -Math.pow(10, -power) /
          (error >= e10$1 ? 10 : error >= e5$1 ? 5 : error >= e2$1 ? 2 : 1);
  }
  ...
  var ribbon = function () {
    ...
    ribbon.radius = function (_) {
      return arguments.length
        ? ((radius = typeof _ === "function" ? _ : constant$6(+_)), ribbon)
        : radius;
    };
  ...
  var polygonContains = function (polygon, point) {
    ...
    return (
      (angle < -epsilon$2 || (angle < epsilon$2 && sum$2 < -epsilon$2)) ^
      (winding & 1)
    );
  };
  var lengthSum = adder();
  ...
  var enclose = function (circles) {
    var i = 0,
      n = (circles = shuffle$2(slice$4.call(circles))).length,
      B = [],
      p,
      e;
    while (i < n) {
  ...
  function continuous(deinterpolate, reinterpolate) {
    ...
    scale.domain = function (_) {
      return arguments.length
        ? ((domain = map$4.call(_, number$3)), rescale())
        : domain.slice();
    };
    scale.range = function (_) {
      return arguments.length
        ? ((range$$1 = slice$6.call(_)), rescale())
        : range$$1.slice();
    };
    scale.rangeRound = function (_) {
      return (
        (range$$1 = slice$6.call(_)),
  ...
  function identity$7() {
    ...
    scale.domain = scale.range = function (_) {
      return arguments.length
        ? ((domain = map$4.call(_, number$3)), scale)
        : domain.slice();
    };
    scale.copy = function () {
  ...
  function quantize$1() {
    ...
    scale.range = function (_) {
      return arguments.length
        ? ((n = (range$$1 = slice$6.call(_)).length - 1), rescale())
        : range$$1.slice();
    };
    scale.invertExtent = function (y) {
      var i = range$$1.indexOf(y);
  ...
  function parseYear(d, string, i) {
    ...
    return n
      ? ((d.y = +n[0] + (+n[0] > 68 ? 1900 : 2e3)), i + n[0].length)
      : -1;
  }
  ...
  var arc = function () {
    ...
    arc.innerRadius = function (_) {
      return arguments.length
        ? ((innerRadius = typeof _ === "function" ? _ : constant$11(+_)), arc)
        : innerRadius;
    };
    arc.outerRadius = function (_) {
      return arguments.length
        ? ((outerRadius = typeof _ === "function" ? _ : constant$11(+_)), arc)
        : outerRadius;
    };
    arc.cornerRadius = function (_) {
      return arguments.length
        ? ((cornerRadius = typeof _ === "function" ? _ : constant$11(+_)), arc)
        : cornerRadius;
    };
    arc.padRadius = function (_) {
      return arguments.length
        ? ((padRadius =
            _ == null ? null : typeof _ === "function" ? _ : constant$11(+_)),
          arc)
        : padRadius;
    };
    arc.startAngle = function (_) {
      return arguments.length
        ? ((startAngle = typeof _ === "function" ? _ : constant$11(+_)), arc)
        : startAngle;
    };
    arc.endAngle = function (_) {
      return arguments.length
        ? ((endAngle = typeof _ === "function" ? _ : constant$11(+_)), arc)
        : endAngle;
    };
    arc.padAngle = function (_) {
      return arguments.length
        ? ((padAngle = typeof _ === "function" ? _ : constant$11(+_)), arc)
        : padAngle;
    };
  ...
  var line = function () {
    ...
    line.x = function (_) {
      return arguments.length
        ? ((x$$1 = typeof _ === "function" ? _ : constant$11(+_)), line)
        : x$$1;
    };
    line.y = function (_) {
      return arguments.length
        ? ((y$$1 = typeof _ === "function" ? _ : constant$11(+_)), line)
        : y$$1;
    };
    line.defined = function (_) {
      return arguments.length
        ? ((defined = typeof _ === "function" ? _ : constant$11(!!_)), line)
        : defined;
    };
  ...
  var area$2 = function () {
    ...
    area.x = function (_) {
      return arguments.length
        ? ((x0 = typeof _ === "function" ? _ : constant$11(+_)),
          (x1 = null),
          area)
        : x0;
    };
    area.x0 = function (_) {
      return arguments.length
        ? ((x0 = typeof _ === "function" ? _ : constant$11(+_)), area)
        : x0;
    };
    area.x1 = function (_) {
      return arguments.length
    ...
    area.y = function (_) {
      return arguments.length
        ? ((y0 = typeof _ === "function" ? _ : constant$11(+_)),
          (y1 = null),
          area)
        : y0;
    };
    area.y0 = function (_) {
      return arguments.length
        ? ((y0 = typeof _ === "function" ? _ : constant$11(+_)), area)
        : y0;
    };
    area.y1 = function (_) {
      return arguments.length
    ...
    area.defined = function (_) {
      return arguments.length
        ? ((defined = typeof _ === "function" ? _ : constant$11(!!_)), area)
        : defined;
    };
  ...
  var pie = function () {
    ...
    pie.value = function (_) {
      return arguments.length
        ? ((value = typeof _ === "function" ? _ : constant$11(+_)), pie)
        : value;
    };
    ...
    pie.startAngle = function (_) {
      return arguments.length
        ? ((startAngle = typeof _ === "function" ? _ : constant$11(+_)), pie)
        : startAngle;
    };
    pie.endAngle = function (_) {
      return arguments.length
        ? ((endAngle = typeof _ === "function" ? _ : constant$11(+_)), pie)
        : endAngle;
    };
    pie.padAngle = function (_) {
      return arguments.length
        ? ((padAngle = typeof _ === "function" ? _ : constant$11(+_)), pie)
        : padAngle;
    };
    return pie;
  };
  ...
  function link$2(curve) {
    ...
    link.x = function (_) {
      return arguments.length
        ? ((x$$1 = typeof _ === "function" ? _ : constant$11(+_)), link)
        : x$$1;
    };
    link.y = function (_) {
      return arguments.length
        ? ((y$$1 = typeof _ === "function" ? _ : constant$11(+_)), link)
        : y$$1;
    };
  ...
  var symbols = [circle$2, cross$3, diamond, square, star, triangle, wye];
  var symbol = function () {
    ...
    symbol.type = function (_) {
      return arguments.length
        ? ((type = typeof _ === "function" ? _ : constant$11(_)), symbol)
        : type;
    };
    symbol.size = function (_) {
      return arguments.length
        ? ((size = typeof _ === "function" ? _ : constant$11(+_)), symbol)
        : size;
    };
  ...
  var stack = function () {
    ...
    stack.keys = function (_) {
      return arguments.length
        ? ((keys = typeof _ === "function" ? _ : constant$11(slice$7.call(_))),
          stack)
        : keys;
    };
    stack.value = function (_) {
      return arguments.length
        ? ((value = typeof _ === "function" ? _ : constant$11(+_)), stack)
        : value;
    };
  ...
  var voronoi = function () {
    ...
    voronoi.x = function (_) {
      return arguments.length
        ? ((x$$1 = typeof _ === "function" ? _ : constant$12(+_)), voronoi)
        : x$$1;
    };
    voronoi.y = function (_) {
      return arguments.length
        ? ((y$$1 = typeof _ === "function" ? _ : constant$12(+_)), voronoi)
        : y$$1;
    };
  ...
  var zoom = function () {
    ...
    function wheeled() {
      ...
      var g = gesture(this, arguments),
        ...
        k = Math.max(
          k0,
          Math.min(k1, t.k * Math.pow(2, wheelDelta.apply(this, arguments)))
        ),
        p = mouse(this);
      if (g.wheel) {
    ...
    zoom.wheelDelta = function (_) {
      return arguments.length
        ? ((wheelDelta = typeof _ === "function" ? _ : constant$13(+_)), zoom)
        : wheelDelta;
    };
    zoom.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === "function" ? _ : constant$13(!!_)), zoom)
        : filter;
    };
  ...
  var transition_attrs = function (map) {
    return (typeof map === "function" ? attrsFunction$1 : attrsObject$1)(
      this,
      map
    );
  };
  ...
  var transition_styles = function (map, priority) {
    return (typeof map === "function" ? stylesFunction$1 : stylesObject$1)(
      this,
      map,
      priority == null ? "" : priority
    );
  ...
  var insert = function (name, before) {
    ...
    var s = this.select(function () {
      return this.insertBefore(
        create.apply(this, arguments),
        select$$1.apply(this, arguments) || null
      );
    });
    for (var key in n.attr) {
  ...
  var tspans = function (lines, lh) {
    return this.selectAll("tspan")
      .data(function (d) {
        return (typeof lines == "function" ? lines(d) : lines).map(
          function (l) {
  ...
  var appendMany = function (name, data) {
    if (typeof data == "string") {
      console.warn(
        "DEPRECATED: jetpack's appendMany order of arguments has changed. It's appendMany('div', data) from now on"
      );
      var temp = data;
      data = name;
      name = temp;
  ...
  var conventions = function (c) {
    ...
    if (c.parentSel) c.sel = c.parentSel;
  ...
  var drawAxis = function (c) {
    var xAxisSel = c.svg
      ...
      .call(c.xAxis);
    var yAxisSel = c.svg.append("g").attr("class", "y axis").call(c.yAxis);
