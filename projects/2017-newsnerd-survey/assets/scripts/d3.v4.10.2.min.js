...
(function (t, n) {
  ...
  function r(t, n, e) {
    var r = (n - t) / Math.max(0, e),
      ...
      o = r / Math.pow(10, i);
    return i >= 0
      ? (o >= Ts ? 10 : o >= ks ? 5 : o >= Ns ? 2 : 1) * Math.pow(10, i)
      : -Math.pow(10, -i) / (o >= Ts ? 10 : o >= ks ? 5 : o >= Ns ? 2 : 1);
  }
  function i(t, n, e) {
      ...
      ((M = M.merge(
        ...
        (E = E.merge(
          N.append("text")
            .attr("fill", "#000")
            .attr(v, d * y)
            .attr("dy", t === qs ? "0em" : t === Ds ? "0.71em" : "0.32em")
        )),
        e !== w &&
          ((M = M.transition(e)),
          (T = T.transition(e)),
    ...
    return (
      ...
      (e.tickArguments = function (t) {
        return arguments.length
          ? ((r = null == t ? [] : Rs.call(t)), e)
          : r.slice();
      }),
      (e.tickValues = function (t) {
        return arguments.length
          ? ((i = null == t ? null : Rs.call(t)), e)
          : i && i.slice();
      }),
  ...
  function y(t) {
    return function () {
      var n = this.ownerDocument,
        e = this.namespaceURI;
      return e === Ys && n.documentElement.namespaceURI === Ys
        ? n.createElement(t)
  ...
  function z(t, n, e, r, i, o, u) {
    ...
    for (a = 0; a < l; ++a)
      (c = n[a]) &&
        ((p[a] = s = of + u.call(c, c.__data__, a, n)),
        s in f ? (i[a] = c) : (f[s] = c));
    for (a = 0; a < h; ++a)
      (c = f[(s = of + u.call(t, o[a], a, o))])
  ...
  function B(t, n) {
    return (
      ...
      uf(t).getComputedStyle(t, null).getPropertyValue(n)
    );
  }
  function j(t) {
    return function () {
  ...
  function qt(t) {
    ...
    var e = Yt(t.r),
      r = Yt(t.g),
      i = Yt(t.b),
      o = Ot((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / Ef),
      u = Ot((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / Af);
    return new Dt(
      116 * u - 16,
      500 * (o - u),
      200 * (u - Ot((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / Cf)),
      t.opacity
    );
  }
  function Ut(t, n, e, r) {
  ...
  function Jt(t, n) {
    var e = n - t;
    return e
      ? Zt(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
      : Jf(isNaN(t) ? n : t);
  }
  function Qt(t) {
    return 1 == (t = +t)
    ...
    function u(t, n, e, o) {
      t !== n
        ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
          o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: rl(t, n) }))
        : n && e.push(i(e) + "rotate(" + n + r);
    }
    function a(t, n, e, o) {
      t !== n
        ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: rl(t, n) })
  ...
  function gn() {
    for (var t, n, e = Vf, r = 1 / 0; e; )
      e._call
        ? (r > e._time && (r = e._time), (t = e), (e = e._next))
        : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Vf = n)));
    ((Wf = t), mn(r));
  }
  function mn(t) {
    Ml ||
      ...
      t - El > 24
        ? (t < 1 / 0 && (Tl = setTimeout(_n, t - Cl.now() - Al)),
          kl && (kl = clearInterval(kl)))
        : (kl || ((Sl = Cl.now()), (kl = setInterval(yn, Nl))),
          (Ml = 1),
          zl(_n)));
  }
  function xn(t, n) {
        ...
        if ((h = a[s]).name === e.name) {
          ...
          h.state === Fl
            ? ((h.state = Yl),
              ...
              delete a[s])
            : +s < n && ((h.state = Yl), h.timer.stop(), delete a[s]);
        }
      if (
        (Pl(function () {
          e.state === Ol &&
            ((e.state = Fl), e.timer.restart(i, e.delay, e.time), i(c));
        }),
        (e.state = Dl),
        ...
        for (
          e.state = Ol, u = new Array((l = e.tween.length)), s = 0, f = -1;
          s < l;
          ++s
        )
      ...
      for (
        var r =
            n < e.duration
              ...
              : (e.timer.restart(o), (e.state = Il), 1),
          i = -1,
          a = u.length;
        ++i < a;
      )
  ...
  function $n(t, n, e) {
    ...
    return function () {
      var u = B(this, t),
        a = e(this);
      return (
        null == a && (this.style.removeProperty(t), (a = B(this, t))),
  ...
  function he(n) {
    ...
    function u() {
      function e() {
        ...
        (!L ||
          x ||
          b ||
          (Math.abs(t[0] - U[0]) > Math.abs(t[1] - U[1]) ? (b = !0) : (x = !0)),
          (U = t),
          (m = !0),
          xh(),
          o());
      ...
      function o() {
        ...
        switch (((y = U[0] - q[0]), (g = U[1] - q[1]), T)) {
          ...
          case bh:
            (k &&
              ((y = Math.max(C - a, Math.min(P - p, y))),
              (s = a + y),
              (d = p + y)),
              N &&
                ((g = Math.max(z - l, Math.min(R - v, g))),
                (h = l + g),
                (_ = v + g)));
            break;
          case Mh:
            (k < 0
              ? ((y = Math.max(C - a, Math.min(P - a, y))),
                (s = a + y),
                (d = p))
              : k > 0 &&
                ((y = Math.max(C - p, Math.min(P - p, y))),
                (s = a),
                (d = p + y)),
              N < 0
                ? ((g = Math.max(z - l, Math.min(R - l, g))),
                  (h = l + g),
                  (_ = v))
                : N > 0 &&
                  ((g = Math.max(z - v, Math.min(R - v, g))),
                  (h = l),
                  (_ = v + g)));
            break;
          case Th:
            (k &&
              ((s = Math.max(C, Math.min(P, a - y * k))),
              (d = Math.max(C, Math.min(P, p + y * k)))),
              N &&
                ((h = Math.max(z, Math.min(R, l - g * N))),
                (_ = Math.max(z, Math.min(R, v + g * N)))));
        }
        (d < s &&
          ((k *= -1),
          (t = a),
          ...
          (s = d),
          (d = t),
          M in Ah && F.attr("cursor", Eh[(M = Ah[M])])),
          _ < h &&
            ((N *= -1),
            (t = l),
            (l = v),
            ...
            (h = _),
            (_ = t),
            M in Ch && F.attr("cursor", Eh[(M = Ch[M])])),
          S.selection && (A = S.selection),
          x && ((s = A[0][0]), (d = A[1][0])),
          b && ((h = A[0][1]), (_ = A[1][1])),
          (A[0][0] === s && A[0][1] === h && A[1][0] === d && A[1][1] === _) ||
            ((S.selection = [
              [s, h],
              [d, _],
            ]),
    ...
    return (
      ...
      (o.prototype = {
        ...
        emit: function (t) {
          N(new mh(e, t, n.output(this.state.selection)), l.apply, l, [
            t,
            this.that,
            this.args,
          ]);
  ...
  function $e(n) {
    return (
      (bp = Tp(n)),
      (t.format = bp.format),
      (t.formatPrefix = bp.formatPrefix),
      bp
    );
  }
  function Ve() {
  ...
  function dr(t, n) {
    ...
    if (Yp) {
      ...
      (s ^ (a * Op < c && c < a * t)
        ...
        s
          ? t < Op
            ? xr(Lp, t) > xr(Lp, Up) && (Up = t)
            : xr(t, Up) > xr(Lp, Up) && (Lp = t)
          : Up >= Lp
            ? (t < Lp && (Lp = t), t > Up && (Up = t))
            : t > Op
              ? xr(Lp, t) > xr(Lp, Up) && (Up = t)
  ...
  function Or(t, n, e, r, i, o) {
    if (e) {
      ...
      for (var s, f = i; r > 0 ? f > o : f < o; f -= c)
        ((s = ur([u, -a * yd(f), -a * wd(f)])), t.point(s[0], s[1]));
    }
  }
  function Fr(t, n) {
    (((n = ar(n))[0] -= t), hr(n));
    ...
    return function (u) {
      ...
      function f(o, u) {
        ...
        if ((h && p.push([o, u]), x))
          ...
          var c = [
              (y = Math.max(tv, Math.min(Kd, y))),
              (g = Math.max(tv, Math.min(Kd, g))),
            ],
            s = [
              (o = Math.max(tv, Math.min(Kd, o))),
              (u = Math.max(tv, Math.min(Kd, u))),
            ];
          Gd(c, s, t, n, e, r)
  ...
  function ti() {
    ...
    function n() {
      return Ms(gd(o / _) * _, i, _)
        .map(h)
        .concat(Ms(gd(s / y) * y, c, y).map(p))
        .concat(
          Ms(gd(r / d) * d, e, d)
            .filter(function (t) {
              return dd(t % _) > ad;
  ...
  function xi(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - sd - ad : sd - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - sd - ad : sd - n[1])
    );
  }
  function bi(t, n, e, r) {
    var i,
    ...
    return dd(u) > ad
      ? vd(
          (wd(n) * (o = yd(r)) * wd(e) - wd(r) * (i = yd(n)) * wd(t)) /
            (i * o * u)
        )
      : (n + r) / 2;
  }
  ...
  function Ai(t) {
    ...
    function e(t) {
      return (
        (t = f.invert((t[0] - a) / _, (c - t[1]) / _)) && [t[0] * hd, t[1] * hd]
      );
    }
    function r(t, n) {
    ...
    return (
      ...
      (n.clipAngle = function (t) {
        return arguments.length
          ? ((k = +t ? Fv((T = t * pd), 6 * pd) : ((T = null), Ov)), o())
          : T * hd;
      }),
  ...
  function bo(t) {
    ...
    t: for (a = 3; a < i; ++a) {
      ...
      for (
        r.previous = n, r.next = e, n.next = e.previous = e = r, o = mo(n);
        (r = r.next) !== e;
      )
        (u = mo(r)) < o && ((n = r), (o = u));
      e = n.next;
    ...
    for (var n, e, r, i, o, u = new Do(t, 0), a = [u]; (n = a.pop()); )
      if ((r = n._.children))
        for (n.children = new Array((o = r.length)), i = o - 1; i >= 0; --i)
          (a.push((e = n.children[i] = new Do(r[i], i))), (e.parent = n));
  ...
  function Fo(t, n, e, r, i, o) {
    for (
      ...
      (y.push((u = { value: f, dice: c < s, children: g.slice(m, x) })),
        u.dice
          ? Qv(u, e, r, i, w ? (r += (s * f) / w) : o)
          : e_(u, e, r, w ? (e += (c * f) / w) : i, o),
        (w -= f),
        (m = x));
    }
    return y;
    ...
    return function (e, r) {
      t._tasks[n] &&
        ...
        null == t._error &&
          (null != e
            ? $o(t, e)
            : ((t._data[n] = r), t._waiting ? jo(t) : Vo(t))));
    };
  }
  function $o(t, n) {
    var e,
  ...
  function au(t, n) {
    function e() {
      return (
        (i = Math.min(a.length, c.length) > 2 ? ou : iu),
        (o = u = null),
        r
      );
    }
  ...
  function wu() {
    ...
    return (
      (t.domain = function (i) {
        return arguments.length
          ? ((n = S_.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : n.slice();
      }),
      (t.range = function (i) {
        return arguments.length
          ? ((e = S_.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : e.slice();
      }),
      (t.invertExtent = function (t) {
        var r = e.indexOf(t);
  ...
  function Tu(t) {
    return Mu(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * O_) / F_
        );
      }
    );
  }
  ...
  function Au(t) {
    ...
    function e(t, n) {
      return function (e) {
        ...
        return "Z" in i
          ? ((i.H += (i.Z / 100) | 0), (i.M += i.Z % 100), Su(i))
          : n(i);
      };
    }
    function r(t, n, e, r) {
      for (var i, o, u = 0, a = n.length, c = e.length; u < a; ) {
        ...
        if (37 === (i = n.charCodeAt(u++))) {
          if (
            ((i = n.charAt(u++)),
            !(o = T[i in Dy ? n.charAt(u++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
    ...
    function l(n, e, r, o) {
      if ((null == n && (n = 10), "number" == typeof n)) {
        ...
        a === M.length
          ? ((o = i(e / Zy, r / Zy, n)), (n = t))
          : a
            ? ((o = (a = M[u / M[a - 1][2] < M[a][2] / u ? a - 1 : a])[1]),
              (n = a[0]))
            : ((o = i(e, r, n)), (n = c));
      }
  ...
  function $a(t) {
    ...
    return (
      ...
      (n.x = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : sg(+t)), n)
          : i;
      }),
      (n.y = function (t) {
        return arguments.length
          ? ((o = "function" == typeof t ? t : sg(+t)), n)
          : o;
      }),
  ...
  function Ac(t, n, e, r) {
    ...
    return (
      ...
      e && zc(i, t, n, e),
      r && zc(i, n, t, r),
      sm[t.index].halfedges.push(o),
      sm[n.index].halfedges.push(o),
      i
    );
  }
  function Cc(t, n, e) {
  ...
  function Lc(t, n, e, r) {
    for (var i, o = lm.length; o--; )
      (Rc((i = lm[o]), t, n, e, r) &&
        Pc(i, t, n, e, r) &&
        (Math.abs(i[0][0] - i[1][0]) > dm ||
          Math.abs(i[0][1] - i[1][1]) > dm)) ||
        delete lm[o];
  }
  function qc(t) {
  ...
  function Fc() {
    for (var t, n, e, r, i = 0, o = sm.length; i < o; ++i)
      if ((t = sm[i]) && (r = (n = t.halfedges).length)) {
        var u = new Array(r),
          a = new Array(r);
  ...
  function Ic(t, n, e, r) {
      ...
      if ((o = sm[i])) {
        ...
        for (a = 0, s = c.length; a < s; )
          ((d = (p = Oc(o, lm[c[a]]))[0]),
            ...
            (l = (f = Dc(o, lm[c[++a % s]]))[0]),
            (h = f[1]),
            (Math.abs(d - l) > dm || Math.abs(v - h) > dm) &&
              (c.splice(
                a,
                0,
                lm.push(
                  Cc(
                    u,
                    p,
                    Math.abs(d - t) < dm && r - v > dm
                      ? [t, Math.abs(l - t) < dm ? h : r]
                      : Math.abs(v - r) < dm && e - d > dm
                        ? [Math.abs(h - r) < dm ? l : e, r]
                        : Math.abs(d - e) < dm && v - n > dm
                          ? [e, Math.abs(l - e) < dm ? h : n]
                          : Math.abs(v - n) < dm && d - t > dm
                            ? [Math.abs(h - n) < dm ? l : t, n]
                            : null
                  )
                ) - 1
              ),
    ...
    if (y) {
      ...
      for (i = 0, y = null; i < _; ++i)
        (o = sm[i]) &&
          (x = (g = (u = o.site)[0] - t) * g + (m = u[1] - n) * m) < b &&
          ((b = x), (y = o));
      if (y) {
        var w = [t, n],
          M = [t, r],
  ...
  function jc(t) {
    var n = t.circle;
    n &&
      (n.P || (am = n.N), fm.remove(n), hm.push(n), kc(n), (t.circle = null));
  }
  function Hc() {
  ...
  function Vc(t) {
    ...
    for (
      var c = o;
      c.circle &&
      Math.abs(e - c.circle.x) < dm &&
      Math.abs(r - c.circle.cy) < dm;
    )
      ((o = c.P), a.unshift(c), $c(c), (c = o));
    (a.unshift(c), jc(c));
    for (
      var s = u;
      s.circle &&
      Math.abs(e - s.circle.x) < dm &&
      Math.abs(r - s.circle.cy) < dm;
    )
      ((u = s.N), a.push(s), $c(s), (s = u));
    (a.push(s), jc(s));
    var f,
      l = a.length;
    for (f = 1; f < l; ++f)
      ((s = a[f]), (c = a[f - 1]), zc(s.edge, c.site, s.site, i));
    ((c = a[0]),
      ((s = a[l - 1]).edge = Ac(c.site, s.site, null, i)),
      Bc(c),
      Bc(s));
  }
  function Wc(t) {
    for (var n, e, r, i, o = t[0], u = t[1], a = cm._; a; )
      if ((r = Zc(a, u) - o) > dm) a = a.L;
      else {
        if (!((i = o - Gc(a, u)) > dm)) {
          r > -dm
            ? ((n = a.P), (e = a))
    ...
    if ((cm.insert(n, c), n || e)) {
      ...
      if (e) {
        ...
        (zc(e.edge, s, d, x),
          (c.edge = Ac(s, t, null, x)),
          (e.edge = Ac(t, d, null, x)),
          Bc(n),
          Bc(e));
  ...
  function Kc(t, n) {
    var e,
      ...
      i,
      o = t.sort(Qc).pop();
    for (lm = [], sm = new Array(t.length), cm = new Tc(), fm = new Tc(); ; )
      if (((i = am), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
        ((o[0] === e && o[1] === r) || (Wc(o), (e = o[0]), (r = o[1])),
          (o = t.pop()));
      else {
        if (!i) break;
        Vc(i.arc);
  ...
  var ss = function (t, n) {
    ...
    vs = function (t, n) {
      ...
      if (null == n)
        for (; ++u < i; )
          isNaN((e = ds(t[u]))) || (c += (r = e - a) * (e - (a += r / ++o)));
      else
        for (; ++u < i; )
          isNaN((e = ds(n(t[u], u, t)))) ||
            (c += (r = e - a) * (e - (a += r / ++o)));
      if (o > 1) return c / (o - 1);
    },
    _s = function (t, n) {
  ...
  var Ys = "http://www.w3.org/1999/xhtml",
    ...
    js = function (t) {
      ...
      return (
        ...
        Bs.hasOwnProperty(n) ? { space: Bs[n], local: t } : t
      );
    },
    Hs = function (t) {
      var n = js(t);
  ...
  if ("undefined" != typeof document) {
    ...
    if (!Vs.matches) {
      var Ws =
        Vs.webkitMatchesSelector ||
        Vs.msMatchesSelector ||
        Vs.mozMatchesSelector ||
        Vs.oMatchesSelector;
      $s = function (t) {
        return function () {
  ...
  ((t.event = null),
    "undefined" != typeof document &&
      ("onmouseenter" in document.documentElement ||
        (Gs = { mouseenter: "mouseover", mouseleave: "mouseout" })));
  var Js = function () {
  ...
  pt.prototype = dt.prototype = {
    ...
    sort: function (t) {
      ...
      for (
        ...
        for (
          var o, u = n[i], a = u.length, c = (r[i] = new Array(a)), s = 0;
          s < a;
          ++s
        )
          (o = u[s]) && (c[s] = o);
    ...
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each(
            (null == n ? F : "function" == typeof n ? Y : I)(
              t,
              n,
              null == e ? "" : e
            )
    ...
    on: function (t, n, e) {
      ...
      {
        if (!(arguments.length < 2)) {
          for (a = n ? k : T, null == e && (e = !1), r = 0; r < u; ++r)
            this.each(a(o[r], n, e));
          return this;
        }
  ...
  var jf,
    ...
    al = function (t, n) {
      var e,
        ...
        a = [],
        c = [];
      for (t += "", n += ""; (e = ol.exec(t)) && (r = ul.exec(n)); )
        ((i = r.index) > o &&
      ...
      function (t) {
        return "none" === t
          ...
          : (jf ||
              ...
              (Hf = document.documentElement),
              (Xf = document.defaultView)),
            (jf.style.transform = t),
            (t = Xf.getComputedStyle(Hf.appendChild(jf), null).getPropertyValue(
              "transform"
            )),
            Hf.removeChild(jf),
            (t = t.slice(7, -1).split(",")),
            hl(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
      },
      "px, ",
      "px)",
      "deg)"
        ...
        return null == t
          ...
          : ($f ||
            ...
            (t = $f.transform.baseVal.consolidate())
              ? ((t = t.matrix), hl(t.a, t.b, t.c, t.d, t.e, t.f))
              : ll);
      },
      ", ",
      ")",
  ...
  pn.prototype = dn.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      ((e = (null == e ? ln() : +e) + (null == n ? 0 : +n)),
        this._next ||
          Wf === this ||
          (Wf ? (Wf._next = this) : (Vf = this), (Wf = this)),
        (this._call = t),
        (this._time = e),
        mn());
    },
  ...
  Gn.prototype = Jn.prototype = {
    ...
    attr: function (t, n) {
      ...
      return this.attrTween(
        t,
        "function" == typeof n
          ? (e.local ? Pn : zn)(e, r, Nn(this, "attr." + t, n))
          : null == n
            ? (e.local ? En : Sn)(e)
            : (e.local ? Cn : An)(e, r, n + "")
      );
    ...
    style: function (t, n, e) {
      ...
      return null == n
        ? this.styleTween(t, jn(t, r)).on("end.style." + t, Hn(t))
        : this.styleTween(
            t,
            "function" == typeof n
              ? $n(t, r, Nn(this, "style." + t, n))
              : Xn(t, r, n + ""),
            e
          );
    },
    ...
    tween: function (t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = wn(this.node(), e).tween, o = 0, u = i.length;
          o < u;
          ++o
        )
    ...
    delay: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(("function" == typeof t ? qn : Un)(n, t))
        : wn(this.node(), n).delay;
    },
    duration: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(("function" == typeof t ? Dn : On)(n, t))
        : wn(this.node(), n).duration;
    },
    ease: function (t) {
      var n = this._id;
  ...
  var Wl = (function t(n) {
    ...
    _h = { time: null, delay: 0, duration: 250, ease: te };
  ((dt.prototype.interrupt = function (t) {
    ...
    (dt.prototype.transition = function (t) {
      ...
      t instanceof Gn
        ? ((n = t._id), (t = t._name))
        : ((n = Qn()), ((e = _h).time = ln()), (t = null == t ? null : t + ""));
      for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
        for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)
          (u = a[s]) && Bl(u, t, n, s, a, e || oe(u, n));
      ...
      function n(t, n) {
        function e() {
          ...
          if (t.charCodeAt(r) === Vh) {
            for (
              ;
              (a++ < u && t.charCodeAt(a) !== Vh) || t.charCodeAt(++a) === Vh;
            );
            return (
              (n = a) >= u
                ? (s = !0)
                : (e = t.charCodeAt(a++)) === Wh
                  ? (f = !0)
                  : e === Zh && ((f = !0), t.charCodeAt(a) === Wh && ++a),
              t.slice(r + 1, n - 1).replace(/""/g, '"')
            );
          }
          for (; a < u; ) {
            if ((e = t.charCodeAt((n = a++))) === Wh) f = !0;
            else if (e === Zh) ((f = !0), t.charCodeAt(a) === Wh && ++a);
        ...
        var r,
          ...
          f = !1;
        for (
          t.charCodeAt(u - 1) === Wh && --u, t.charCodeAt(u - 1) === Zh && --u;
          (r = e()) !== $h;
        ) {
  ...
  ((fp.copy = function () {
    ...
    (fp.visit = function (t) {
      var n,
        ...
        c = this._root;
      for (
        c && a.push(new sp(c, this._x0, this._y0, this._x1, this._y1));
        (n = a.pop());
      )
        if (
          ...
          var s = (r + o) / 2,
            f = (i + u) / 2;
          ((e = c[3]) && a.push(new sp(e, s, f, o, u)),
            (e = c[2]) && a.push(new sp(e, r, f, s, u)),
            (e = c[1]) && a.push(new sp(e, s, i, o, f)),
            (e = c[0]) && a.push(new sp(e, r, i, s, f)));
        }
      return this;
    }),
    (fp.visitAfter = function (t) {
      ...
      for (
        this._root &&
        e.push(new sp(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
      ) {
        var i = n.node;
        if (i.length) {
          var o,
            ...
            f = (u + c) / 2,
            l = (a + s) / 2;
          ((o = i[0]) && e.push(new sp(o, u, a, f, l)),
            (o = i[1]) && e.push(new sp(o, f, a, c, l)),
            (o = i[2]) && e.push(new sp(o, u, l, f, s)),
            (o = i[3]) && e.push(new sp(o, f, l, c, s)));
        }
        r.push(n);
      }
  ...
  var kp = function (t) {
    ...
    Np = function (t, n) {
      return Math.max(
        0,
        3 * Math.max(-8, Math.min(8, Math.floor(vp(n) / 3))) - vp(Math.abs(t))
      );
    },
    Sp = function (t, n) {
      return (
  ...
  Ve.prototype = {
    ...
    add: function (t) {
      (We(ud, t, this.t),
        We(this, ud.s, this.s),
        this.s ? (this.t += ud.t) : (this.s = ud.t));
    },
    valueOf: function () {
      return this.s;
    },
  ...
  var Dd,
    ...
    Wd = function (t) {
      ...
      return (
        (t = Lr(t[0] * pd, t[1] * pd, t.length > 2 ? t[2] * pd : 0)),
        (n.invert = function (n) {
          return (
            (n = t.invert(n[0] * pd, n[1] * pd)),
            (n[0] *= hd),
            (n[1] *= hd),
            n
          );
    ...
    dv = {
      ...
      polygonEnd: function () {
        ((dv.lineStart = dv.lineEnd = dv.point = Qe),
          hv.add(dd(pv)),
          pv.reset());
      },
      result: function () {
      ...
      switch (this._point) {
        ...
        default:
          (this._context.moveTo(t + this._radius, n),
            this._context.arc(t, n, this._radius, 0, ld));
      }
    },
    result: Qe,
  };
        ...
        var p,
          ...
          b = {
            ...
            polygonEnd: function () {
              ...
              var t = ev(p, y);
              (d.length
                ? (x || (o.polygonStart(), (x = !0)), Qd(d, xi, t, e, o))
                : t &&
          ...
          return {
            ...
            point: function (l, h) {
              ...
              if (
                (!n && (s = c = v) && t.lineStart(),
                v !== c &&
                  (!(p = r(n, d)) || Jd(n, p) || Jd(d, p)) &&
                  ((d[0] += ad), (d[1] += ad), (v = e(d[0], d[1]))),
                v !== c)
              )
                ((f = 0),
                  v
                    ? (t.lineStart(), (p = r(d, n)), t.point(p[0], p[1]))
                    : ((p = r(n, d)), t.point(p[0], p[1]), t.lineEnd()),
                  (n = p));
              else if (a && n && u ^ v) {
                var y;
                _ & o ||
  ...
  uo.prototype = eo.prototype = {
    ...
    path: function (t) {
      for (var n = this, e = no(n, t), r = [n]; n !== e; )
        ((n = n.parent), r.push(n));
  ...
  var Wv = Array.prototype.slice,
    Zv = function (t) {
      for (var n, e, r = 0, i = (t = ao(Wv.call(t))).length, o = []; r < i; )
        ((n = t[r]), e && fo(e, n) ? ++r : ((e = ho((o = co(o, n)))), (r = 0)));
      return e;
    },
    Gv = function (t) {
      return function () {
        ...
        if ((u = t._squarify) && u.ratio === n)
          for (
            ...
            for (
              ...
              a.value += c[s].value;
            (a.dice
              ? Qv(a, e, r, i, (r += ((o - r) * a.value) / p))
              : e_(a, e, r, (e += ((i - e) * a.value) / p), o),
              (p -= a.value));
          }
    ...
    P_ = function (n, e, r) {
      ...
      switch ((r = He(null == r ? ",f" : r)).type) {
        case "s":
          ...
          return (
            null != r.precision || isNaN((o = Np(c, s))) || (r.precision = o),
            t.formatPrefix(r, s)
          );
        case "":
        case "e":
        ...
        case "r":
          null != r.precision ||
            isNaN((o = Sp(c, Math.max(Math.abs(u), Math.abs(a))))) ||
  ...
  var D_ = U_.range,
    ...
    $_ = Mu(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * O_) / 864e5
        );
      },
      function (t) {
        return t.getDate() - 1;
  ...
  var Yy = Date.prototype.toISOString
    ...
    By = +new Date("2000-01-01T00:00:00.000Z")
      ? function (t) {
          var n = new Date(t);
    ...
    ng = wl($t(300, 0.5, 0), $t(-240, 0.5, 1)),
    eg = wl($t(-100, 0.75, 0.35), $t(80, 1.5, 0.8)),
    rg = wl($t(260, 0.75, 0.35), $t(80, 1.5, 0.8)),
    ig = $t(),
    og = Sa(
      Gy(
  ...
  var bg = function (t) {
    ...
    wg = function () {
      ...
      return (
        (t.x = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : sg(+e)), t)
            : n;
        }),
        (t.y = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : sg(+n)), t)
            : e;
        }),
        (t.defined = function (n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : sg(!!n)), t)
            : r;
        }),
        (t.curve = function (n) {
    ...
    Mg = function () {
      ...
      return (
        (t.x = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : sg(+n)), (r = null), t)
            : e;
        }),
        (t.x0 = function (n) {
          return arguments.length
        ...
        (t.x1 = function (n) {
          return arguments.length
            ? ((r = null == n ? null : "function" == typeof n ? n : sg(+n)), t)
            : r;
        }),
        (t.y = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : sg(+n)), (o = null), t)
            : i;
        }),
        (t.y0 = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : sg(+n)), t)
            : i;
        }),
        (t.y1 = function (n) {
          return arguments.length
            ? ((o = null == n ? null : "function" == typeof n ? n : sg(+n)), t)
            : o;
        }),
        (t.lineX0 = t.lineY0 =
          function () {
    ...
    Vg = {
      draw: function (t, n) {
        ...
        (t.moveTo(r, i),
          t.lineTo(o, u),
          t.lineTo(a, c),
          t.lineTo(jg * r - Hg * i, Hg * r + jg * i),
          t.lineTo(jg * o - Hg * u, Hg * o + jg * u),
          t.lineTo(jg * a - Hg * c, Hg * a + jg * c),
          t.lineTo(jg * r + Hg * i, jg * i - Hg * r),
          t.lineTo(jg * o + Hg * u, jg * u - Hg * o),
          t.lineTo(jg * a + Hg * c, jg * c - Hg * a),
          t.closePath());
      },
    },
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = gc(t), i = gc(n), o = 0, u = 1; u < e; ++o, ++u)
    ...
    insert: function (t, n) {
      ...
      for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
        (e === (r = e.U).L
          ? (i = r.R) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
            : (t === e.R && (Nc(this, e), (e = (t = e).U)),
              (e.C = !1),
              (r.C = !0),
              Sc(this, r))
          : (i = r.L) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
            : (t === e.L && (Sc(this, e), (e = (t = e).U)),
              (e.C = !1),
              (r.C = !0),
              Nc(this, r)),
          (e = t.U));
        ...
        if (t && t.C) t.C = !1;
          ...
          do {
            ...
            if (t === i.L) {
              if (
                ((n = i.R).C &&
                  ((n.C = !1), (i.C = !0), Nc(this, i), (n = i.R)),
                (n.L && n.L.C) || (n.R && n.R.C))
              ) {
                ((n.R && n.R.C) ||
                  ((n.L.C = !1), (n.C = !0), Sc(this, n), (n = i.R)),
                  (n.C = i.C),
                  (i.C = n.R.C = !1),
                  Nc(this, i),
                  (t = this._));
              ...
              ((n = i.L).C && ((n.C = !1), (i.C = !0), Sc(this, i), (n = i.L)),
              (n.L && n.L.C) || (n.R && n.R.C))
            ) {
              ((n.L && n.L.C) ||
                ((n.R.C = !1), (n.C = !0), Nc(this, n), (n = i.L)),
                (n.C = i.C),
                (i.C = n.L.C = !1),
                Sc(this, i),
                (t = this._));
  ...
  ((t.version = "4.10.2"),
    ...
    (t.histogram = function () {
      function t(t) {
        ...
        Array.isArray(h) ||
          ((h = i(f, l, h)),
          (h = Ms(Math.ceil(f / h) * h, Math.floor(l / h) * h, h)));
        ...
        for (o = 0; o <= p; ++o)
          (((d = v[o] = []).x0 = o > 0 ? h[o - 1] : f),
            (d.x1 = o < p ? h[o] : l));
        for (o = 0; o < a; ++o)
          f <= (u = c[o]) && u <= l && v[hs(h, u, 0, p)].push(t[o]);
        return v;
      }
      var n = ws,
        e = ys,
      ...
      return (
        (t.value = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : bs(e)), t)
            : n;
        }),
        (t.domain = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : bs([n[0], n[1]])), t)
            : e;
        }),
        (t.thresholds = function (n) {
          return arguments.length
            ? ((r =
                "function" == typeof n
                  ? n
                  : bs(Array.isArray(n) ? ms.call(n) : n)),
              t)
            : r;
        }),
        t
    ...
    (t.thresholdFreedmanDiaconis = function (t, n, e) {
      return (
        (t = xs.call(t, ds).sort(ss)),
        Math.ceil(
          (e - n) /
            (2 * (As(t, 0.75) - As(t, 0.25)) * Math.pow(t.length, -1 / 3))
        )
      );
    }),
    ...
    (t.mean = function (t, n) {
      var e,
        ...
        o = -1,
        u = 0;
      if (null == n) for (; ++o < r; ) isNaN((e = ds(t[o]))) ? --i : (u += e);
      else for (; ++o < r; ) isNaN((e = ds(n(t[o], o, t)))) ? --i : (u += e);
      if (i) return u / i;
    }),
    (t.median = function (t, n) {
      var e,
        ...
        i = -1,
        o = [];
      if (null == n) for (; ++i < r; ) isNaN((e = ds(t[i]))) || o.push(e);
      else for (; ++i < r; ) isNaN((e = ds(n(t[i], i, t)))) || o.push(e);
      return As(o.sort(ss), 0.5);
    }),
    (t.merge = Cs),
    (t.min = zs),
    ...
    (t.ribbon = function () {
      function t() {
        ...
        if (
          ...
          u.arc(0, 0, f, l, h),
          (l === _ && h === y) ||
            (u.quadraticCurveTo(0, 0, v * Rh(_), v * Lh(_)),
            u.arc(0, 0, v, _, y)),
      ...
      return (
        (t.radius = function (n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : Ih(+n)), t)
            : r;
        }),
        (t.startAngle = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : Ih(+n)), t)
            : i;
        }),
        (t.endAngle = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : Ih(+n)), t)
            : o;
        }),
        (t.source = function (e) {
    ...
    (t.nest = function () {
      function t(n, i, u, a) {
        ...
        for (
          var c, s, f, l = -1, h = n.length, p = o[i++], d = we(), v = u();
          ++l < h;
        )
    ...
    (t.drag = function () {
      ...
      function i() {
        (cf(t.event.view).on("mousemove.drag mouseup.drag", null),
          _t(t.event.view, l),
          ff(),
          y.mouse("end"));
      }
      function o() {
        if (d.apply(this, arguments)) {
          var n,
            ...
            o = r.length;
          for (n = 0; n < o; ++n)
            (e = c(r[n].identifier, i, sf, this, arguments)) &&
              (vt(), e("start"));
        }
      }
      function u() {
      ...
      function c(e, r, i, o, u) {
        ...
        if (
          N(
            new yt(n, "beforestart", a, e, m, f[0], f[1], 0, 0, l),
            function () {
              return (
      ...
      return (
        (n.filter = function (t) {
          return arguments.length
            ? ((d = "function" == typeof t ? t : hf(!!t)), n)
            : d;
        }),
        (n.container = function (t) {
          return arguments.length
            ? ((v = "function" == typeof t ? t : hf(t)), n)
            : v;
        }),
        (n.subject = function (t) {
          return arguments.length
            ? ((_ = "function" == typeof t ? t : hf(t)), n)
            : _;
        }),
        (n.on = function () {
    ...
    (t.forceCollide = function (t) {
      ...
      var i,
        ...
        a = 1;
      return (
        "function" != typeof t && (t = ap(null == t ? 1 : +t)),
        ...
        (n.radius = function (e) {
          return arguments.length
            ? ((t = "function" == typeof e ? e : ap(+e)), r(), n)
            : t;
        }),
        n
      );
    ...
    (t.forceLink = function (t) {
      function n(n) {
        for (var e = 0, r = t.length; e < p; ++e)
          for (var i, a, c, f, l, h, d, v = 0; v < r; ++v)
            ((a = (i = t[v]).source),
              (f = (c = i.target).x + c.vx - a.x - a.vx || cp()),
              (l = c.y + c.vy - a.y - a.vy || cp()),
              (f *= h =
      ...
      return (
        ...
        (n.strength = function (t) {
          return arguments.length
            ? ((l = "function" == typeof t ? t : ap(+t)), r(), n)
            : l;
        }),
        (n.distance = function (t) {
          return arguments.length
            ? ((h = "function" == typeof t ? t : ap(+t)), i(), n)
            : h;
        }),
        n
      );
    ...
    (t.forceManyBody = function () {
      ...
      return (
        ...
        (t.strength = function (e) {
          return arguments.length
            ? ((c = "function" == typeof e ? e : ap(+e)), n(), t)
            : c;
        }),
    ...
    (t.forceX = function (t) {
      ...
      var r,
        ...
        u = ap(0.1);
      return (
        "function" != typeof t && (t = ap(null == t ? 0 : +t)),
        (n.initialize = function (t) {
          ((r = t), e());
        }),
        (n.strength = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : ap(+t)), e(), n)
            : u;
        }),
        (n.x = function (r) {
          return arguments.length
            ? ((t = "function" == typeof r ? r : ap(+r)), e(), n)
            : t;
        }),
        n
      );
    ...
    (t.geoBounds = function (t) {
      var n, e, r, i, o, u, a;
      if (
        ((Dp = Up = -(Lp = qp = 1 / 0)), (Bp = []), Ed(t, Rd), (e = Bp.length))
      ) {
        for (Bp.sort(br), n = 1, o = [(r = Bp[0])]; n < e; ++n)
          wr(r, (i = Bp[n])[0]) || wr(r, i[1])
            ? (xr(r[0], i[1]) > xr(r[0], r[1]) && (r[1] = i[1]),
              xr(i[0], r[1]) > xr(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
        for (u = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          ((i = o[n]),
            (a = xr(r[1], i[0])) > u && ((u = a), (Lp = i[0]), (Up = r[1])));
      }
      return (
        (Bp = jp = null),
        Lp === 1 / 0 || qp === 1 / 0
    ...
    (t.geoCentroid = function (t) {
      ...
      return i < 1e-12 &&
        ...
        (i = n * n + e * e + r * r) < 1e-12)
        ? [NaN, NaN]
        : [_d(e, n) * hd, Ge(r / Td(i)) * hd];
    }),
    (t.geoCircle = function () {
      function t() {
        var t = r.apply(this, arguments),
          a = i.apply(this, arguments) * pd,
          c = o.apply(this, arguments) * pd;
        return (
          (n = []),
          (e = Lr(-t[0] * pd, -t[1] * pd, 0).invert),
          Or(u, a, c, 1),
      ...
      return (
        (t.center = function (n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : qd([+n[0], +n[1]])), t)
            : r;
        }),
        (t.radius = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : qd(+n)), t)
            : i;
        }),
        (t.precision = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : qd(+n)), t)
            : o;
        }),
        t
      );
    ...
    (t.geoPath = function (t, n) {
      ...
      return (
        ...
        (e.projection = function (n) {
          return arguments.length
            ? ((r = null == n ? ((t = null), lv) : (t = n).stream), e)
            : t;
        }),
        (e.context = function (t) {
          return arguments.length
            ? ((i = null == t ? ((n = null), new yi()) : new di((n = t))),
    ...
    (t.geoAlbersUsa = function () {
      ...
      return (
        ...
        (t.stream = function (t) {
          return e && r === t
            ? e
            : (e = Ri([c.stream((r = t)), s.stream(t), f.stream(t)]));
        }),
        ...
        (t.translate = function (t) {
          ...
          return (
            ...
            (o = s
              ...
              .clipExtent([
                [r - 0.425 * e + ad, a + 0.12 * e + ad],
                [r - 0.214 * e - ad, a + 0.234 * e - ad],
              ])
              .stream(l)),
            (u = f
              .translate([r - 0.205 * e, a + 0.212 * e])
              .clipExtent([
                [r - 0.214 * e + ad, a + 0.166 * e + ad],
                [r - 0.115 * e - ad, a + 0.234 * e - ad],
              ])
              .stream(l)),
            n()
          );
    ...
    (t.geoIdentity = function () {
      ...
      return (u = {
        ...
        scale: function (n) {
          return arguments.length
            ? ((h = ji((a = +n) * f, a * l, c, s)), t())
            : a;
        },
        translate: function (n) {
          return arguments.length
            ? ((h = ji(a * f, a * l, (c = +n[0]), (s = +n[1]))), t())
            : [c, s];
        },
        reflectX: function (n) {
          return arguments.length
            ? ((h = ji(a * (f = n ? -1 : 1), a * l, c, s)), t())
            : f < 0;
        },
        reflectY: function (n) {
          return arguments.length
            ? ((h = ji(a * f, a * (l = n ? -1 : 1), c, s)), t())
            : l < 0;
        },
    ...
    (t.pack = function () {
      function t(t) {
        return (
          ...
          (t.y = r / 2),
          n
            ? t.eachBefore(No(n)).eachAfter(So(i, 0.5)).eachBefore(Eo(1))
            : t
                .eachBefore(No(ko))
                .eachAfter(So(To, 1))
                .eachAfter(So(i, t.r / Math.min(e, r)))
                .eachBefore(Eo(Math.min(e, r) / (2 * t.r))),
          t
        );
      }
      var n = null,
    ...
    (t.partition = function () {
      ...
      function n(t, n) {
        return function (e) {
          e.children &&
            Qv(e, e.x0, (t * (e.depth + 1)) / n, e.x1, (t * (e.depth + 2)) / n);
          var r = e.x0,
            o = e.y0,
            u = e.x1 - i,
            a = e.y1 - i;
      ...
      function r(t, n, e) {
        if (n) {
          for (
            ...
            ((c = Po(c)),
              ((u = Ro(u)).a = t),
              (r = a.z + l - i.z - s + o(a._, i._)) > 0 &&
                (Lo(Uo(a, t, e), t, r), (s += r), (f += r)),
              (l += a.m),
              (s += i.m),
              (h += c.m),
              (f += u.m));
          (a && !Ro(u) && ((u.t = a), (u.m += l - f)),
            i && !Po(c) && ((c.t = i), (c.m += s - h), (e = t)));
        }
        return e;
      }
      function i(t) {
    ...
    (t.treemap = function () {
      ...
      return (
        ...
        (t.paddingTop = function (n) {
          return arguments.length
            ? ((c = "function" == typeof n ? n : Gv(+n)), t)
            : c;
        }),
        (t.paddingRight = function (n) {
          return arguments.length
            ? ((s = "function" == typeof n ? n : Gv(+n)), t)
            : s;
        }),
        (t.paddingBottom = function (n) {
          return arguments.length
            ? ((f = "function" == typeof n ? n : Gv(+n)), t)
            : f;
        }),
        (t.paddingLeft = function (n) {
          return arguments.length
            ? ((l = "function" == typeof n ? n : Gv(+n)), t)
            : l;
        }),
        t
      );
    ...
    (t.treemapSquarify = i_),
    (t.treemapResquarify = o_),
    (t.interpolate = cl),
    (t.interpolateArray = nl),
    (t.interpolateBasis = Zf),
    (t.interpolateBasisClosed = Gf),
    (t.interpolateDate = el),
    (t.interpolateNumber = rl),
    (t.interpolateObject = il),
    (t.interpolateRound = sl),
    (t.interpolateString = al),
    (t.interpolateTransformCss = pl),
    (t.interpolateTransformSvg = dl),
    (t.interpolateZoom = _l),
    (t.interpolateRgb = Qf),
    (t.interpolateRgbBasis = Kf),
    (t.interpolateRgbBasisClosed = tl),
    (t.interpolateHsl = yl),
    ...
    (t.interpolateHcl = ml),
    (t.interpolateHclLong = xl),
    (t.interpolateCubehelix = bl),
    (t.interpolateCubehelixLong = wl),
    ...
    (t.randomUniform = f_),
    (t.randomNormal = l_),
    (t.randomLogNormal = h_),
    (t.randomBates = d_),
    (t.randomIrwinHall = p_),
    (t.randomExponential = v_),
    (t.request = __),
    (t.html = g_),
    (t.json = m_),
    (t.text = x_),
    ...
    (t.scaleSqrt = function () {
      return mu().exponent(0.5);
    }),
    (t.scaleQuantile = xu),
    (t.scaleQuantize = bu),
    (t.scaleThreshold = wu),
    (t.scaleTime = function () {
      return Na(fy, cy, W_, $_, H_, B_, I_, U_, t.timeFormat).domain([
        new Date(2e3, 0, 1),
        new Date(2e3, 0, 2),
      ]);
    }),
    (t.scaleUtc = function () {
      return Na(Ly, Py, gy, _y, dy, hy, I_, U_, t.utcFormat).domain([
        Date.UTC(2e3, 0, 1),
        Date.UTC(2e3, 0, 2),
      ]);
    }),
    (t.schemeCategory10 = Jy),
    (t.schemeCategory20b = Qy),
    (t.schemeCategory20c = Ky),
    (t.schemeCategory20 = tg),
    (t.interpolateCubehelixDefault = ng),
    ...
    (t.interpolateWarm = eg),
    (t.interpolateCool = rg),
    (t.interpolateViridis = og),
    (t.interpolateMagma = ug),
    (t.interpolateInferno = ag),
    (t.interpolatePlasma = cg),
    (t.scaleSequential = Ea),
    (t.creator = Hs),
    (t.local = m),
    (t.matcher = Zs),
    (t.mouse = Ks),
    ...
    (t.arc = function () {
      function t() {
        var t,
          ...
          d = fg(p - h),
          v = p > h;
        if ((c || (c = t = ve()), l < f && ((s = l), (l = f), (f = s)), l > yg))
          if (d > xg - yg)
            (c.moveTo(l * hg(h), l * vg(h)),
              c.arc(0, 0, l, h, p, !v),
              f > yg &&
                (c.moveTo(f * hg(p), f * vg(p)), c.arc(0, 0, f, p, h, v)));
          else {
            var _,
              y,
              g = h,
                  ...
                  E < N
                    ...
                    : (c.arc(
                      ...
                      c.arc(
                        ...
                        0,
                        l,
                        lg(_.cy + _.y11, _.cx + _.x11),
                        lg(y.cy + y.y11, y.cx + y.x11),
                        !v
                      ),
                      c.arc(
                        y.cx,
      ...
      return (
        ...
        (t.padRadius = function (n) {
          return arguments.length
            ? ((i = null == n ? null : "function" == typeof n ? n : sg(+n)), t)
            : i;
        }),
        (t.startAngle = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : sg(+n)), t)
            : o;
        }),
        (t.endAngle = function (n) {
          return arguments.length
    ...
    (t.curveBundle = Gg),
    (t.curveCardinalClosed = Qg),
    (t.curveCardinalOpen = Kg),
    (t.curveCardinal = Jg),
    (t.curveCatmullRomClosed = nm),
    (t.curveCatmullRomOpen = em),
    (t.curveCatmullRom = tm),
    ...
    (t.stack = function () {
      ...
      return (
        (t.keys = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : sg(Cg.call(e))), t)
            : n;
        }),
        (t.value = function (n) {
          return arguments.length
        ...
        (t.order = function (n) {
          return arguments.length
            ? ((e =
                null == n ? im : "function" == typeof n ? n : sg(Cg.call(n))),
              t)
            : e;
        }),
        (t.offset = function (n) {
    ...
    (t.timeInterval = Mu),
    (t.timeMillisecond = U_),
    (t.timeMilliseconds = D_),
    (t.utcMillisecond = U_),
    (t.utcMilliseconds = D_),
    (t.timeSecond = I_),
    (t.timeSeconds = Y_),
    (t.utcSecond = I_),
    (t.utcSeconds = Y_),
    ...
    (t.utcYear = Ly),
    (t.utcYears = Uy),
    (t.timeFormatDefaultLocale = Ma),
    (t.timeFormatLocale = Au),
    (t.isoFormat = Yy),
    (t.isoParse = By),
    (t.now = ln),
    (t.timer = dn),
    ...
    (t.active = function (t, n) {
      ...
      if (i) {
        n = null == n ? null : n + "";
        for (r in i)
          if ((e = i[r]).state > Ul && e.name === n)
            return new Gn([[t]], yh, n, +r);
      }
      return null;
    }),
    (t.interrupt = jl),
    (t.voronoi = function () {
      ...
      return (
        ...
        (t.x = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : um(+e)), t)
            : n;
        }),
        (t.y = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : um(+n)), t)
            : e;
        }),
        (t.extent = function (n) {
          return arguments.length
    ...
    (t.zoom = function () {
      ...
      function e(t, n) {
        return (n = Math.max(b, Math.min(w, n))) === t.k
          ? t
          : new ns(n, t.x, t.y);
      }
      function r(t, n, e) {
      ...
      function s() {
        if (g.apply(this, arguments)) {
          var t = a(this, arguments),
            ...
            o = Math.max(
              b,
              Math.min(w, n.k * Math.pow(2, x.apply(this, arguments)))
            ),
            u = Ks(this);
          if (t.wheel)
              ...
              .on(
                ...
                function () {
                  ...
                  n.zoom(
                    "mouse",
                    i(
                      r(n.that.__zoom, (n.mouse[0] = Ks(n.that)), n.mouse[1]),
                      n.extent
                    )
                  );
                },
      ...
      function l() {
        if (g.apply(this, arguments)) {
          var o = this.__zoom,
            ...
            c = o.invert(a),
            s = i(
              r(e(o, o.k * (t.event.shiftKey ? 0.5 : 2)), a, c),
              m.apply(this, arguments)
            );
          (gm(),
            E > 0
              ? cf(this).transition().duration(E).call(u, s, a)
              : cf(this).call(n.transform, s));
        }
      }
      function p() {
        if (g.apply(this, arguments)) {
          ...
          if (_ && ((_ = clearTimeout(_)), !o.touch1))
            return (
              o.end(),
              void (
                (i = cf(this).on("dblclick.zoom")) && i.apply(this, arguments)
              )
            );
          n &&
      ...
      function d() {
        var n,
          ...
          l = f.length;
        for (gm(), _ && (_ = clearTimeout(_)), n = 0; n < l; ++n)
          ((o = f[n]),
            (u = sf(this, f, o.identifier)),
      ...
      return (
        ...
        (c.prototype = {
          start: function () {
            return (
              1 == ++this.active &&
                ((this.index = C.push(this) - 1), this.emit("start")),
              this
            );
          },
          zoom: function (t, n) {
            ...
            return (
              0 == --this.active &&
                (C.splice(this.index, 1), (this.index = -1), this.emit("end")),
              this
            );
          },
          emit: function (t) {
            N(new ts(n, t, this.that.__zoom), z.apply, z, [
              t,
              this.that,
              this.args,
            ]);
        ...
        (n.wheelDelta = function (t) {
          return arguments.length
            ? ((x = "function" == typeof t ? t : _m(+t)), n)
            : x;
        }),
        (n.filter = function (t) {
          return arguments.length
            ? ((g = "function" == typeof t ? t : _m(!!t)), n)
            : g;
        }),
        (n.extent = function (t) {
          return arguments.length
